    ...
    <div className="min-h-screen">
      ...
      <section className="bg-navy-gradient text-white py-14">
        <div className="container text-center">
          ...
          <p className="text-white/70 mb-6">ดูโครงสร้างองค์กร กระบวนการทำงาน และกฎระเบียบของเรา</p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/services/how-we-work" className="px-5 py-2.5 bg-white/10 text-white font-semibold rounded-lg hover:bg-white/20 transition-colors text-sm">
              กระบวนการทำงาน
            </Link>
