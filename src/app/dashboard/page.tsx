...
import { FolderOpen, Clock, Calendar, Plus, ArrowRight, Scale, Users, FileSearch, ShieldAlert } from "lucide-react";
import { format, formatDistanceToNow } from "date-fns";
import { CASE_STATUS_LABELS } from "../../../drizzle/schema";

const STATUS_LABELS: Record<string, string> = CASE_STATUS_LABELS;
...
export default function Dashboard() {
  ...
  const canCreateCase = myPermissions?.includes("create_case") ?? false;
  ...
  const statCards = [
    ...
    { title: "Pending Warrants", value: stats?.pendingWarrants ?? 0, icon: ShieldAlert, color: "text-red-600", bg: "bg-red-50 dark:bg-red-900/20", change: "Awaiting approval" },
  ];
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              canCreateCase ? { icon: FolderOpen, label: "New Case", href: "/dashboard/cases/new", color: "text-blue-600 bg-blue-50 dark:bg-blue-900/20" } : null,
